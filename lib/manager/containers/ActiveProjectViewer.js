...
const mapStateToProps = (state, ownProps) => {
  return {
    project: state.projects.all
      ? state.projects.all.find(p => p.id === ownProps.match.params.projectId)
      : null,
    visibilityFilter: state.projects.filter,
    activeComponent: ownProps.match.params.subpage,
    activeSubComponent: ownProps.match.params.subsubpage,
    user: state.user,
